...
public class FeiqUtil {
    ...
    public static void sendGroupMsg(String msg,FeiQiuGroup feiQiuGroup,FeiQiuHost feiQiuHost) {
        try {
            ...
            long groupNum = feiQiuGroup.getGroupNum();
            String userName = feiQiuHost.getUserName();
            String pcName = feiQiuHost.getPcName();
            String mac = feiQiuHost.getMac();
